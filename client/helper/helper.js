const navOnHover = () => {
  ...
  logo.addEventListener(
    "mouseover",
    () => (logo.src = "assets/images/face.png")
  );
  logo.addEventListener(
    "mouseout",
    () => (logo.src = "assets/images/face_gray.png")
  );
  ...
  linkedIn.addEventListener(
    "mouseout",
    () => (linkedIn.src = "assets/images/linkedin_gray.png")
  );
  ...
  github.addEventListener(
    "mouseout",
    () => (github.src = "assets/images/github_gray.png")
  );
};
